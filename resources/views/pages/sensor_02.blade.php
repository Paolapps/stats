...
<section id="about" class="section-white">
 <div class="container-fluid"> 
            ...
            <div class="well graph" id="stats_2">
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        ...
                        <p class="stats" ><span class="data5" id="c2_statReenter"></span></br>Returning visitors</p>
     ...
     <div class="row">   
        <div class="col-sm-8 col-sm-offset-2"> 
          <h5>Time of customers in Store Sensor-2 (Values less than 0 are not displayed)</h5>
