...
class Sensor_04_Controller extends Controller
{
   public function sensor_04(){
    ...
    /*SELECT hash_address, round(AVG(time_sec))/60 as avgMin, AVG(signal_db*-1) 
      as newSignal from corner04_inputs where time_sec > 60 and time_sec < 120 
    ...
    public function min_02(){
        $data_min_2 = \DB::table('corner04_inputs')
                    ->select('hash_address', DB::raw('(round(avg(time_sec)/60)) as avgMin'),
                            DB::raw('round(avg(signal_db*-1))as newSignal'))
                    ->where('time_sec', '>', 60)
                    ->where('time_sec', '<', 120)
    ...
    public function min_03(){
        $data_min_3 = \DB::table('corner04_inputs')
                    ->select('hash_address', DB::raw('(round(avg(time_sec)/60)) as avgMin'),
                            DB::raw('round(avg(signal_db*-1))as newSignal'))
                    ->where('time_sec', '>', 120)
                    ->where('time_sec', '<', 180)
    ...
    public function min_04(){
        $data_min_4 =  \DB::table('corner04_inputs')
                    ->select('hash_address', DB::raw('(round(avg(time_sec)/60)) as avgMin'),
                            DB::raw('round(avg(signal_db*-1))as newSignal'))
                    ->where('time_sec', '>', 180)
                    ->where('time_sec', '<', 240)
    ...
    public function min_05(){
         $data_min_5 = \DB::table('corner04_inputs')
                    ->select('hash_address', DB::raw('(round(avg(time_sec)/60)) as avgMin'),
                            DB::raw('round(avg(signal_db*-1))as newSignal'))
                    ->where('time_sec', '>', 240)
                    ->where('time_sec', '<', 300)
    ...
    public function min_06(){  
       $data_min_6 = \DB::table('corner04_inputs')
                    ->select('hash_address', DB::raw('(round(avg(time_sec)/60)) as avgMin'),
                            DB::raw('round(avg(signal_db*-1))as newSignal'))
                    ->where('time_sec', '>', 300)
                    ->where('time_sec', '<', 360)
    ...
    public function min_07(){
       $data_min_7 = \DB::table('corner04_inputs')
                    ->select('hash_address', DB::raw('(round(avg(time_sec)/60)) as avgMin'),
                            DB::raw('round(avg(signal_db*-1))as newSignal'))
                    ->where('time_sec', '>', 360)
                    ->where('time_sec', '<', 420)        
    ...
    public function min_08(){
        $data_min_8 = \DB::table('corner04_inputs')
                    ->select('hash_address', DB::raw('(round(avg(time_sec)/60)) as avgMin'),
                            DB::raw('round(avg(signal_db*-1))as newSignal'))
                    ->where('time_sec', '>', 420)
                    ->where('time_sec', '<', 480)
    ...
    public function min_09(){
        $data_min_9 = \DB::table('corner04_inputs')
                    ->select('hash_address', DB::raw('(round(avg(time_sec)/60)) as avgMin'),
                            DB::raw('round(avg(signal_db*-1))as newSignal'))
                    ->where('time_sec', '>', 480)
                    ->where('time_sec', '<', 540)
    ...
    public function min_10(){
        $data_min_10 = \DB::table('corner04_inputs')
                    ->select('hash_address', DB::raw('(round(avg(time_sec)/60)) as avgMin'),
                            DB::raw('round(avg(signal_db*-1))as newSignal'))
                    ->where('time_sec', '>', 540)
                    ->where('time_sec', '<', 600)
    ...
    public function signal_min_02(){
        $dB_2 = Sensor_04_Controller::col_dB_min_02();
    ...
    public function signal_min_03(){
        $dB_3 = Sensor_04_Controller::col_dB_min_03();
    ...
    public function signal_min_04(){
        $dB_4 = Sensor_04_Controller::col_dB_min_04();
        $numCust_4 = Sensor_04_Controller::count_min_04(); 
        return $avgSignal_4 = round(array_sum($dB_4)/$numCust_4);
    } 
    public function signal_min_05(){
        $dB_5 = Sensor_04_Controller::col_dB_min_05();
        $numCust_5 = Sensor_04_Controller::count_min_05();
        return $avgSignal_5 = round(array_sum($dB_5)/$numCust_5);
    } 
    public function signal_min_06(){
        $dB_6 = Sensor_04_Controller::col_dB_min_06();
        $numCust_6 = Sensor_04_Controller::count_min_06();
        return $avgSignal_6 = round(array_sum($dB_6)/$numCust_6);
    } 
    public function signal_min_07(){
        $dB_7 = Sensor_04_Controller::col_dB_min_07();
        $numCust_7 = Sensor_04_Controller::count_min_07(); 
        return $avgSignal_7 = round(array_sum($dB_7)/$numCust_7);
    } 
    public function signal_min_08(){
        $dB_8 = Sensor_04_Controller::col_dB_min_08();
        $numCust_8 = Sensor_04_Controller::count_min_08();
        return $avgSignal_8 = round(array_sum($dB_8)/$numCust_8);
    } 
    public function signal_min_09(){
        $dB_9 = Sensor_04_Controller::col_dB_min_09();
    ...
    public function signal_min_10(){
        $dB_10 = Sensor_04_Controller::col_dB_min_10();
    ...
    public function c4_avgMins(){
        ...
        $minutes = \DB::table('corner04_inputs')
        	    ->select('hash_address', DB::raw('(round(avg(time_sec)/60)) as avgMin'))
                    ->groupBy('hash_address')
                    ->orderBy('avgMin', 'DESC')
                    ->get()->toArray();
