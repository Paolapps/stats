...
public function c4_numOfVisits(){
        ...
        $custMin_1 = \DB::table('corner04_inputs')
        ...
        $custMin_2 = \DB::table('corner04_inputs')
                    ->select('hash_address', DB::raw('(round(avg(time_sec)/60)) as avgMin'))
        ...
        $custMin_3 = \DB::table('corner04_inputs')
                    ->select('hash_address', DB::raw('(round(avg(time_sec)/60)) as avgMin'))
        ...
        $custMin_4 = \DB::table('corner04_inputs')
                    ->select('hash_address', DB::raw('(round(avg(time_sec)/60)) as avgMin'))
        ...
        $custMin_5 = \DB::table('corner04_inputs')
                    ->select('hash_address', DB::raw('(round(avg(time_sec)/60)) as avgMin'))
        ...
        $custMin_6 = \DB::table('corner04_inputs')
                    ->select('hash_address', DB::raw('(round(avg(time_sec)/60)) as avgMin'))
        ...
        $custMin_7 = \DB::table('corner04_inputs')
                    ->select('hash_address', DB::raw('(round(avg(time_sec)/60)) as avgMin'))
        ...
        $custMin_8 = \DB::table('corner04_inputs')
                    ->select('hash_address', DB::raw('(round(avg(time_sec)/60)) as avgMin'))
        ...
        $custMin_9 = \DB::table('corner04_inputs')
                    ->select('hash_address', DB::raw('(round(avg(time_sec)/60)) as avgMin'))
        ...
        $custMin_10 = \DB::table('corner04_inputs')
                    ->select('hash_address', DB::raw('(round(avg(time_sec)/60)) as avgMin'))
