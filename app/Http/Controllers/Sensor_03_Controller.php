 ...
 * Date: 28/08/17
 * 
 * File: Sensor_03_Controller
 * Description: Contains all the functions of Sensor 3
 */
...
class Sensor_03_Controller extends Controller
{
    ...
    public function generalTime() {
        /*SELECT hash_address, round((max(time_sec)-min(time_sec))/60) as realTime 
            FROM `corner03_inputs` group by hash_address */
    ...
    public function c3_timeSignal(){  
        $dB_min = Sensor_03_Controller::timeSignal();
    ...
    public function c3_avgSignal(){
        ...
        $decibels = Sensor_03_Controller::generalSignal();
    ...
    //--------------------------------------------------------------------------
    public function c3_statCust(){ //------------------total customers in sensor
        $custTime = Sensor_03_Controller::generalTime(); 
    ...
    public function c3_statTime(){//--------------------- average time in sensor
        $custTime = Sensor_03_Controller::generalTime();
    ...
    public function c3_statDB(){//----------------------average signal in sensor
